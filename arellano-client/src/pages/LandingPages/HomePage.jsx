...
const HomePage = () => {
  return (
    <div className="flex w-full flex-col bg-blue-200">
      <section className="border-b-1 border-white-900 relative min-h-[28rem] bg-zinc-900 px-4 py-7 sm:px-5 lg:px-7">
        <img
          src={banner}
        ...
        <div className="relative z-10 flex min-h-[22rem] items-start justify-end text-right sm:min-h-[24rem]">
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-100 sm:text-base">
              Explore our selection of musical instruments and audio equipment
              for practice, performance, recording, and everyday use.
            </p>
      ...
      <section className=" border-zinc-900 bg-zinc-200 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mb-6">
          <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-zinc-500">
            Shop Categories
          </p>
          ...
          <p className="mt-2 text-sm text-zinc-600">
            Browse products based on the equipment you are looking for.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <article className="overflow-hidden rounded-3xl border-1 border-zinc-900 bg-zinc-50">
            ...
            <div className="p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600">
                Explore guitars for practice, performance, and everyday playing.
              </p>
          ...
          <article className="overflow-hidden rounded-3xl border-1 border-zinc-900 bg-zinc-50">
            ...
            <div className="p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600">
                Discover keyboards for learning, recording, and live
                performances.
              </p>
          ...
          <article className="overflow-hidden rounded-3xl border-1 border-zinc-900 bg-zinc-50">
            ...
            <div className="p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600">
                Shop audio equipment for listening, recording, and performance
                setups.
              </p>
